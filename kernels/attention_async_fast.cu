...
constexpr int ATTENTION_ASYNC_FAST_BLOCK_SIZE = 256;
...
__device__ __forceinline__ void paged_gqa_lfm2_bf16_async_fast_body(
...
void paged_gqa_lfm2_bf16_async_fast_ps16(
    const __nv_bfloat16* __restrict__ query,
    const __nv_bfloat16* __restrict__ key_cache,
    const __nv_bfloat16* __restrict__ value_cache,
    const uint32_t* __restrict__ block_table,
    ...
    paged_gqa_lfm2_bf16_async_fast_body<16, false>(
...
extern "C" __global__
__launch_bounds__(ATTENTION_ASYNC_FAST_BLOCK_SIZE)
void paged_gqa_lfm2_bf16_async_fast_ps32(
    const __nv_bfloat16* __restrict__ query,
    const __nv_bfloat16* __restrict__ key_cache,
    const __nv_bfloat16* __restrict__ value_cache,
    const uint32_t* __restrict__ block_table,
    ...
    paged_gqa_lfm2_bf16_async_fast_body<32, false>(
        query, key_cache, value_cache, block_table, nullptr, position_ids,
        output, num_tokens, num_pages, block_table_length, 1
    );
}
...
extern "C" __global__
__launch_bounds__(ATTENTION_ASYNC_FAST_BLOCK_SIZE)
void paged_ragged_gqa_lfm2_bf16_async_fast_ps16(
    const __nv_bfloat16* __restrict__ query,
    const __nv_bfloat16* __restrict__ key_cache,
    const __nv_bfloat16* __restrict__ value_cache,
    const uint32_t* __restrict__ block_tables,
    ...
    paged_gqa_lfm2_bf16_async_fast_body<16, true>(
...
extern "C" __global__
__launch_bounds__(ATTENTION_ASYNC_FAST_BLOCK_SIZE)
void paged_ragged_gqa_lfm2_bf16_async_fast_ps32(
    const __nv_bfloat16* __restrict__ query,
    const __nv_bfloat16* __restrict__ key_cache,
    const __nv_bfloat16* __restrict__ value_cache,
    const uint32_t* __restrict__ block_tables,
